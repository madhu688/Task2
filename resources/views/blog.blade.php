                            ...
                            <form action="{{route('blog.save')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" value="{{old('description')}}" class="form-control" rows="3"
                                        placeholder="Enter Description for Blog"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="author_name" value="{{old('author_name')}}" class="form-control" placeholder ="Enter Name author"/>
